...
function Bg({ navigation }) {
    ...
    return (
        ...
        renderItem={({item}) => <Text onPress={() => {navigation.navigate('Bhagavad_Gita_Verses', { chapter: item.key })}} style={{marginLeft:15, marginTop:5}}>{item.key}</Text>}
      />
